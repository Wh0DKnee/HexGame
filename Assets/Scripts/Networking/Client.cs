...
public class Client {
    ...
    public void TellServerUseSkill(int userID, SkillEnum skillEnum, HexCoordinates coordinates) {
        scsClient.ServiceProxy.RequestSkillUse(userID, skillEnum, coordinates);
    }
